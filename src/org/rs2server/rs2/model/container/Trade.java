...
//			if (player.getTrade().getQuestStage(i) != null) {
//				if (player.getTrade().getQuestStage(i).getCount() >= 1000 && player.getTrade().getQuestStage(i).getCount() < 1000000) {
//					tradeStringAmt = "@cya@" + (player.getTrade().getQuestStage(i).getCount() / 1000) + "K @whi@(" + NumberFormat.getInstance().format(player.getTrade().getQuestStage(i).getCount()) + ")";
//				}  else if (player.getTrade().getQuestStage(i).getCount() >= 1000000) {
//					tradeStringAmt = "@gre@" + (player.getTrade().getQuestStage(i).getCount() / 1000000) + " million @whi@(" + NumberFormat.getInstance().format(player.getTrade().getQuestStage(i).getCount()) + ")";
//				} else {
//					tradeStringAmt = "" + NumberFormat.getInstance().format(player.getTrade().getQuestStage(i).getCount());
//				}
//
//				if(amt == 0) {
//					tradeString = ItemDefinition.forId(player.getTrade().getQuestStage(i).getId()).getName();
//				} else {
//					tradeString = tradeString + "\\n" + ItemDefinition.forId(player.getTrade().getQuestStage(i).getId()).getName();
//				}
//				if (ItemDefinition.forId(player.getTrade().getQuestStage(i).getId()).isStackable()) {
...
//
//		for (int i = 0; i < SIZE; i++) {
//			if (partner.getTrade().getQuestStage(i) != null) {
//				if (partner.getTrade().getQuestStage(i).getCount() >= 1000 && partner.getTrade().getQuestStage(i).getCount() < 1000000) {
//					tradeStringAmt = "@cya@" + (partner.getTrade().getQuestStage(i).getCount() / 1000) + "K @whi@(" + NumberFormat.getInstance().format(partner.getTrade().getQuestStage(i).getCount()) + ")";
//				}  else if (partner.getTrade().getQuestStage(i).getCount() >= 1000000) {
//					tradeStringAmt = "@gre@" + (partner.getTrade().getQuestStage(i).getCount() / 1000000) + " million @whi@(" + NumberFormat.getInstance().format(partner.getTrade().getQuestStage(i).getCount()) + ")";
//				} else {
//					tradeStringAmt = "" + NumberFormat.getInstance().format(partner.getTrade().getQuestStage(i).getCount());
//				}
//
//				if (amt == 0) {
//					tradeString = ItemDefinition.forId(partner.getTrade().getQuestStage(i).getId()).getName();
//				} else {
//					tradeString = tradeString + "\\n" +  ItemDefinition.forId(partner.getTrade().getQuestStage(i).getId()).getName();
//				}
//				if (ItemDefinition.forId(partner.getTrade().getQuestStage(i).getId()).isStackable()) {
//					tradeString = tradeString + " x " + tradeStringAmt;
//				}
//				
//				amt++;
