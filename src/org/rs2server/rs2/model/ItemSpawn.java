...
public class ItemSpawn {
	...
	/**
	 * The ground item, setQuestStage after the item is registered.
	 */
	...
	public static void init() throws IOException {
		...
		File file = new File(Constants.ITEM_SPAWNS_FILE);
...
//		XMLController.writeXML(spawns, file);
	...
	/**
	 * @param groundItem the groundItem to setQuestStage
	 */
