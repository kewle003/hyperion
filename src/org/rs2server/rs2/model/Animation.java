...
public class Animation {
    ...
    public final static Animation STEAL_STALL = create(0x340);
    public final static Animation FLARED_DANCE = create(5316);
    public final static Animation ENHANCED_SALUTE = create(5312);
    public final static Animation ENHANCED_YAWN = create(5312);
    public final static Animation ENHANCED_ANGRY = create(5315);
