...
public final class CombatState {
    ...
    /**
     * @param amount the spellDelay to set
     */
    ...
    public void resetPrayers() {
        for (int i = 0; i < prayers.length; i++) {
            prayers[i] = false;
            if (mob.getActionSender() != null) {
                mob.getActionSender().sendConfig(Prayer.forId(i).getClientConfiguration(), 0);
            }
        }
        setPrayerHeadIcon(-1);
    ...
    /**
     * @param ticks the charged to set
     */
     ...
     *
     * @param canDrink The drinking flag to set.
     */
    ...
    /**
     * @param ticks the canVengeance to set
     */
    ...
    /**
     * @param ticks The canSpellbookSwap to set.
     */
