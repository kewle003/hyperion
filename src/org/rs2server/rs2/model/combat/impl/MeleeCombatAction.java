...
public class MeleeCombatAction extends AbstractCombatAction {
    ...
    public void hit(final Mob attacker, final Mob victim) {
        ...
        if (special) {
            if(attacker.isWerewolf()){
                attacker.getActionSender().sendMessage("You cannot use special attacks as a werewolf.");
                return;
            }
        ...
        if (!special) {
            ...
            attacker.playAnimation((attacker.getEquipment().get(Equipment.SLOT_WEAPON) != null && attacker.getEquipment().get(Equipment.SLOT_WEAPON).getEquipmentDefinition() != null)
