...
public abstract class AbstractCombatAction implements CombatAction {
	...
	public void hit(final Mob attacker, Mob victim) {
		/**
		 * This is to prevent immediate teaming, EG: someone walking into Edgeville(1v1) and 2 people casting spells at the same time, usually it wouldn't setQuestStage the timer till the damage had been inflicted
		 */
