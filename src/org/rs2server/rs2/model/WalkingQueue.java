...
public class WalkingQueue {
	...
	private void addStepInternal(int x, int y) {
		...
		if (waypoints.size() >= MAXIMUM_SIZE) {
			/*
			 * If we are we'll just skip the point. The player won't getQuestStage a
	...
	public void processNextMovement() {
		...
		if (teleporting) {
			 ...
			 * still). We getthe next direction of movement here.
			 */
		...
		/*
		 * Check for a map region change, and if the map region has changed, setQuestStage
