...
public class Shop {
	...
	/**
	 * @param defaultStock the defaultStock to setQuestStage
	 */
	...
	/**
	 * @param mainStock the mainStock to setQuestStage
	 */
	...
	/**
	 * @param playerStock the playerStock to setQuestStage
	 */
	...
	public static void init() throws IOException {
		...
		File file = new File(Constants.SHOP_DEFINITIONS_FILE);
