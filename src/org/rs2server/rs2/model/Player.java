...
import org.rs2server.rs2.model.quests.QuestStorage;
...
public class Player extends Mob implements Persistable {
    ...
    /**
     * The Werewolf Vista quest minigame flag.
     */
     ...
     * The quest.
     */
    private Quest quest = QuestRepository.get(-1);
...
//		super();
    ...
    private void saveQuests(QuestStorage questStorage) {
    ...
    /**
     * @param standAnimation the standAnimation to setQuestStage
     */
    ...
    /**
     * @param runAnimation the runAnimation to setQuestStage
     */
    ...
    /**
     * @param walkAnimation the walkAnimation to setQuestStage
     */
    ...
    /**
     * @param standTurnAnimation the standTurnAnimation to setQuestStage
     */
    ...
    /**
     * @param turn90ClockwiseAnimation the turn90ClockwiseAnimation to setQuestStage
     */
     ...
     *         the turn90CounterClockwiseAnimation to setQuestStage
     */
    ...
    /**
     * @param turn180Animation the turn180Animation to setQuestStage
     */
    ...
    /**
     * @param recoveryQuestionsLastSet the recoveryQuestionsLastSet to setQuestStage
     */
    ...
    /**
     * @param lastLoggedIn the lastLoggedIn to setQuestStage
     */
    ...
    /**
     * @param lastLoggedInFrom the lastLoggedInFrom to setQuestStage
     */
    ...
    /**
     * @param receivedStarterRunes the receivedStarterRunes to setQuestStage
     */
    ...
    /**
     * @param debugMode the debugMode to setQuestStage
     */
    ...
    /**
     * @param pnpc the pnpc to setQuestStage
     */
    ...
    /**
     * @param minigame the minigame to setQuestStage
     */
    ...
    /**
     * @param fremennikTrials the fremennikTrials to get
     */
     ...
     *
     * @return questPoints The quest points.
     */
    ...
    /**
     * Sets the quest points
     *
     * @param set The amount to set.
     * @return questPoints
     */
    public int setQuestPoints(int set) {
        return this.questPoints = set;
    }

    /**
     * Increases / adds quest points
     *
     * @param amt The amount to add.
     * @return questPoints
     */
    public int addQuestPoints(int amt) {
        return questPoints += amt;
    }

    /**
     * Decreases / subtracts quest points
     *
     * @param amt The amount to decrease
     * @return questPoints
     */
    public int removeQuestPoints(int amt) {
        return questPoints -= amt;
    }


    /**
     * Checks if the player cutscene state
     *
     * @return inCutScene
     */
    ...
    /**
     * Sets the cutscene state
     *
     * @param b True/False
     * @return inCutScene
     */
    public boolean inCutScene(boolean b) {
        return this.inCutScene = b;
    ...
    /**
     * Gets the quest storage
     *
     * @return questStorage The Quest storage
     */
     ...
     * Sets the cutscene.
     *
     * @param c The cutscene to setQuestStage.
     * @return cutscene The cutscene
     */
    public CutScene setCutScene(CutScene c) {
        return cutScene = c;
    }
    ...
    public void deserialize(IoBuffer buf) {
        ...
        if (buf.hasRemaining()) {
            for (Quest q : QuestRepository.QUEST_DATABASE.values()) {
                getQuestStorage().setQuestStage(q.getQuestButton(), buf.getInt());
            }
            // getQuestStorage().setQuestStage(new WerewolfQuest(), buf.getInt());
            // getQuestStorage().setQuestStage(new DwarfCannonQuest(), buf.getInt());
        }
        if (buf.hasRemaining()) {
    ...
    public void serialize(IoBuffer buf) {
        ...
        for (Quest q : QuestRepository.QUEST_DATABASE.values()) {
            buf.putInt((byte) getQuestStorage().getQuestStage(q));
        }
