...
public class InterfaceState {
	...
	/**
	 * Called when the enter amount interface is closed.
	 * @param text The amount that was entered.
	 */
	...
	/**
	 * @param openShop the openShop to setQuestStage
	 */
	...
	/**
	 * @param openStockType the openStockType to setQuestStage
	 */
	...
	/**
	 * @param openDialogueId the openDialogueId to setQuestStage
	 */
	...
	/**
	 * @param nextDialogueId the nextDialogueId to setQuestStage
	 */
	...
	/**
	 * @param openAutocastType the openAutocastType to setQuestStage
	 */
	...
	/**
	 * @param lastUsedAutocast the lastUsedAutocast to setQuestStage
	 */
	...
	/**
	 * @param publicChat the publicChat to setQuestStage
	 */
	...
	/**
	 * @param privateChat the privateChat to setQuestStage
	 */
	...
	/**
	 * @param trade the trade to setQuestStage
	 */
	...
	/**
	 * @param clan the clan to setQuestStage
	 */
