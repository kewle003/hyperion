...
public class Settings {
	...
	/**
	 * @param brightnessSetting the brightnessSetting to setQuestStage
	 */
	...
	/**
	 * @param twoMouseButtons the twoMouseButtons to setQuestStage
	 */
	...
	/**
	 * @param chatEffects the chatEffects to setQuestStage
	 */
	...
	/**
	 * @param splitPrivateChat the splitPrivateChat to setQuestStage
	 */
	...
	/**
	 * @param acceptAid the acceptAid to setQuestStage
	 */
	...
	/**
	 * @param autoRetaliate the autoRetaliate to setQuestStage
	 */
