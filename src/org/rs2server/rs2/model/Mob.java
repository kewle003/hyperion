...
//		FOLLOW,
    ...
    /**
     * The temporary interface attributes map. items setQuestStage here are removed when interfaces are closed.
     */
    private Map<String, Object> interfaceAttributes = new HashMap<String, Object>();

    /**
     * The permanent attributes map. Items setQuestStage here are only removed when told to.
     */
    ...
    /**
     * A setQuestStage of hits done in this entity during the current update cycle.
     */
    ...
    /**
     * The teleporting types.
     */
    public enum TeleportType {
        NORMAL_TELEPORT(Graphic.create(301), Animation.create(714), 1800),
        ANCIENT_TELEPORT(Graphic.create(392), Animation.create(1979), 2300),
        LUNAR_TELEPORT(Graphic.create(747), Animation.create(1816), 1800);
        ...
        TeleportType(Graphic gfx, Animation anim, int delay) {
            this.gfx = gfx;
            this.anim = anim;
            this.delay = delay;
        }
    ...
    /**
     * Initiates a spell teleport.
     *
     * @param teleportType The teleport type.
     * @param location     The location.
     */
    public void initiateTeleport(final TeleportType teleportType, final Location location) {
        setTeleporting(true);
        getWalkingQueue().reset();

        playAnimation(teleportType.getAnimation());
        playGraphics(Graphic.create(teleportType.getGfx().getId(), teleportType == TeleportType.ANCIENT_TELEPORT ? 0 : (100 << 16)));

        World.getWorld().submit(new Event(teleportType.getDelay()) {
            public void execute() {
                setTeleportTarget(location);
                playAnimation(Animation.create(teleportType == TeleportType.ANCIENT_TELEPORT ? teleportType.getAnimation().getId() + 1 : -1));
                this.stop();
            }
        });
     ...
     * Sets the emote flag.
     *
     * @param emote The emote flag to set.
     */
    ...
    /**
     * Gets the werewolf state.
     * @return isWerewolf The werewolf state.
     */
    ...
    /**
     * Sets the werewolf state.
     * @param state The state.
     * @return isWerewolf The werewolf state.
     */
    public boolean isWerewolf(boolean state){
        return this.isWerewolf = state;
    }
    ...
    /**
     * @param energyRestoreTick the energyRestoreTick to setQuestStage
     */
    ...
    /**
     * @param prayerUpdateTick the prayerUpdateTick to setQuestStage
     */
    ...
    /**
     * @param poisonDrainTick the poisonDrainTick to setQuestStage
     */
     ...
     * @param attacker The damage dealer.
     */
...
//		}
    ...
    /**
     * @param attackDrained the attackDrained to setQuestStage
     */
    ...
    /**
     * @param strengthDrained the strengthDrained to setQuestStage
     */
    ...
    /**
     * @param defenceDrained the defenceDrained to setQuestStage
     */
     ...
     *
     * @param sound     The id.
     * @param sound     The volume.
     * @param sound     The delay.
     */
