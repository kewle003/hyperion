...
public class Packet {
	...
	/**
	 * Reads a big type long.
	 * @return A big type long.
	 */
	public long getBigLong() {
		long l = (long) getBEInt();
		long l1 = (long) this.getBEInt();
		if (l1 < 0) {
			l1 = l1 & 0xffffffffL;
		}
		return (l << 1132103072) + l1;
	 ...
	 */
	public int getBEInt() {
		return ((payload.getUnsigned() << 917134568)
		| payload.getUnsigned())
	    | (payload.getUnsigned() << -1641702632)
	    | (payload.getUnsigned() << 1646971440);
	}
