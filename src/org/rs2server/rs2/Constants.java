...
public class Constants {
     ...
     * The exp modifier
     */
    public static int EXP_MODIFIER = 1;
     ...
     * You can if you want but it's all loaded through game.xml .
     */

    /**
     * The directory for the engine scripts.
     */
    public static String SCRIPTS_DIRECTORY = "./data/scripts/";
    /**
     * The directory for the item definitions.
     */
    public static String ITEM_DEFINITIONS_FILE = "./data/itemDefinitions.bin";
    /**
     * The directory for the npc definitions.
     */
    public static String NPC_DEFINITIONS_FILE = "./data/npcDefinitions.bin";
    /**
     * The directory for the npc combat definitions.
     */
    public static String NPC_COMBAT_DEFINITIONS_FILE = "./data/npcCombatDefinitions.xml";

    /**
     * The directory for the shop definitions.
     */
    public static String SHOP_DEFINITIONS_FILE = "./data/shops.xml";
    /**
     * The directory for the equipment definitions.
     */
    public static String EQUIPMENT_DEFINITIONS_FILE = "./data/equipmentDefinitions.xml";
    /**
     * The directory for the custom objects.
     */
    public static String CUSTOM_OBJECTS_FILE = "./data/customObjects.xml";
    /**
     * The directory for the item spawns.
     */
    public static String ITEM_SPAWNS_FILE = "./data/itemSpawns.xml";
    /**
     * The directory for the npc spawns.
     */
    public static String NPC_SPAWNS_FILE = "./data/npcSpawns.xml";
    /**
     * The directory for the doors.
     */
    public static String DOORS_FILE = "./data/doors.xml";
    /**
     * The directory for the boundaries.
     */
    public static String BOUNDARIES_FILE = "./data/boundaries.xml";
     ...
     * {@true} Will check if the user is registered on the forums
     * {@false} Anyone could login
     */
    public static boolean WEB_AUTH = false;
    /**
     * Checks for users that are members.
     */
    public static boolean MEMBER_CHECK = false;
     ...
     * The NPC cap.
     */
    public static int MAX_NPCS = 32000;
     ...
     * The Administrators.
     */
    public static Set<String> ADMINISTRATORS = new HashSet<String>();
    /**
     * The Moderators.
     */
    public static Set<String> MODERATORS = new HashSet<String>();
    /**
