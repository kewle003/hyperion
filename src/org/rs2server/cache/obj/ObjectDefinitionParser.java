...
public class ObjectDefinitionParser {
	...
	outer_loop:
		...
		listener.objectDefinitionParsed(new GameObjectDefinition(26338, "Boulder", "A large boulder blocks your way.", 4, 2, true, false, true));
		listener.objectDefinitionParsed(new GameObjectDefinition(26341, "Hole", "I wonder what's down there...", 4, 4, true, false, true));
		listener.objectDefinitionParsed(new GameObjectDefinition(26439, "Ice Bridge", "Bridge.", 2, 2, true, false, true));
		listener.objectDefinitionParsed(new GameObjectDefinition(23271, "Wilderness Ditch", "The ditch.", 2, 2, true, false, true));
	}
