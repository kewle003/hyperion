...
function objectOptionOne1747(player, object) {
	player.setTeleportTarget(Location.create(2817, 3352, 1));
}

function objectOptionOne1746(player, object) {
	player.setTeleportTarget(Location.create(2817, 3352, 0));
}
...
function objectOptionTwo4187(player, object) {
	if(player.completedFremennikTrials()) {
		...
		player.setMinigame(new FremennikTrials(player));
	}	
}
