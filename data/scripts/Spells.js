...
function varrockTeleport(mob) {
    mob.initiateTeleport(Mob.TeleportType.NORMAL_TELEPORT, Location.create(3213 + mob.getRandom().nextInt(2 + 1) - mob.getRandom().nextInt(2 + 1), 3424 + mob.getRandom().nextInt(1 + 1) - mob.getRandom().nextInt(1 + 1), 0));
    mob.getSkills().addExperience(Skills.MAGIC, 35);
}

function lumbridgeTeleport(mob) {
    mob.initiateTeleport(Mob.TeleportType.NORMAL_TELEPORT, Location.create(3225 + mob.getRandom().nextInt(1 + 1) - mob.getRandom().nextInt(1 + 1), 3218 + mob.getRandom().nextInt(1 + 1) - mob.getRandom().nextInt(1 + 1), 0));
    mob.getSkills().addExperience(Skills.MAGIC, 41);
}

function faladorTeleport(mob) {
    mob.initiateTeleport(Mob.TeleportType.NORMAL_TELEPORT, Location.create(2964 + mob.getRandom().nextInt(1 + 1) - mob.getRandom().nextInt(1 + 1), 3378 + mob.getRandom().nextInt(1 + 1) - mob.getRandom().nextInt(1 + 1), 0));
    mob.getSkills().addExperience(Skills.MAGIC, 48);
}

function camelotTeleport(mob) {
    mob.initiateTeleport(Mob.TeleportType.NORMAL_TELEPORT, Location.create(2757 + mob.getRandom().nextInt(1 + 1) - mob.getRandom().nextInt(1 + 1), 3477 + mob.getRandom().nextInt(1 + 1) - mob.getRandom().nextInt(1 + 1), 0));
    mob.getSkills().addExperience(Skills.MAGIC, 55.5);
}

function ardougneTeleport(mob) {
    mob.initiateTeleport(Mob.TeleportType.NORMAL_TELEPORT, Location.create(2662 + mob.getRandom().nextInt(4 + 1) - mob.getRandom().nextInt(4 + 1), 3305 + mob.getRandom().nextInt(4 + 1) - mob.getRandom().nextInt(4 + 1), 0));
...
function trollheimTeleport(mob) {
    mob.initiateTeleport(Mob.TeleportType.NORMAL_TELEPORT, Location.create(2891 + mob.getRandom().nextInt(2 + 1) - mob.getRandom().nextInt(2 + 1), 3680 + mob.getRandom().nextInt(2 + 1) - mob.getRandom().nextInt(2 + 1), 0));
    mob.getSkills().addExperience(Skills.MAGIC, 68);
}

function paddewwaTeleport(mob) {
    mob.initiateTeleport(Mob.TeleportType.ANCIENT_TELEPORT, Location.create(3097 + mob.getRandom().nextInt(4 + 1) - mob.getRandom().nextInt(4 + 1), 9882 + mob.getRandom().nextInt(4 + 1) - mob.getRandom().nextInt(4 + 1), 0));
    mob.getSkills().addExperience(Skills.MAGIC, 64);
}

function senntistenTeleport(mob) {
    mob.initiateTeleport(Mob.TeleportType.ANCIENT_TELEPORT, Location.create(3322 + mob.getRandom().nextInt(1 + 1) - mob.getRandom().nextInt(1 + 1), 3336 + mob.getRandom().nextInt(1 + 1) - mob.getRandom().nextInt(1 + 1), 0));
    mob.getSkills().addExperience(Skills.MAGIC, 70);
}

function kharyrllTeleport(mob) {
    mob.initiateTeleport(Mob.TeleportType.ANCIENT_TELEPORT, Location.create(3493 + mob.getRandom().nextInt(1 + 1) - mob.getRandom().nextInt(1 + 1), 3477 + mob.getRandom().nextInt(1 + 1) - mob.getRandom().nextInt(1 + 1), 0));
    mob.getSkills().addExperience(Skills.MAGIC, 76);
}

function lassarTeleport(mob) {
    mob.initiateTeleport(Mob.TeleportType.ANCIENT_TELEPORT, Location.create(3006 + mob.getRandom().nextInt(3 + 1) - mob.getRandom().nextInt(3 + 1), 3471 + mob.getRandom().nextInt(2 + 1) - mob.getRandom().nextInt(2 + 1), 0));
    mob.getSkills().addExperience(Skills.MAGIC, 82);
}

function dareeyakTeleport(mob) {
    mob.initiateTeleport(Mob.TeleportType.ANCIENT_TELEPORT, Location.create(2978 + mob.getRandom().nextInt(3 + 1) - mob.getRandom().nextInt(3 + 1), 3698 + mob.getRandom().nextInt(2 + 1) - mob.getRandom().nextInt(2 + 1), 0));
    mob.getSkills().addExperience(Skills.MAGIC, 88);
}

function carrallangarTeleport(mob) {
    mob.initiateTeleport(Mob.TeleportType.ANCIENT_TELEPORT, Location.create(3156 + mob.getRandom().nextInt(3 + 1) - mob.getRandom().nextInt(3 + 1), 3666 + mob.getRandom().nextInt(2 + 1) - mob.getRandom().nextInt(2 + 1), 0));
    mob.getSkills().addExperience(Skills.MAGIC, 94);
}

function annakarlTeleport(mob) {
    mob.initiateTeleport(Mob.TeleportType.ANCIENT_TELEPORT, Location.create(3288, 3886, 0));
    mob.getSkills().addExperience(Skills.MAGIC, 100);
}

function ghorrockTeleport(mob) {
    mob.initiateTeleport(Mob.TeleportType.ANCIENT_TELEPORT, Location.create(2977 + mob.getRandom().nextInt(3 + 1) - mob.getRandom().nextInt(3 + 1), 3873 + mob.getRandom().nextInt(2 + 1) - mob.getRandom().nextInt(2 + 1), 0));
